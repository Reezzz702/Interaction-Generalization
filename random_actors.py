...
def spawn_actor_assigned(world, client, transform_list):
    ...
    for response in client.apply_batch_sync(batch, synchronous_master):
        if response.error:
            ...
            auto_agent_list.append(response.actor_id)   
    
    all_auto_actors = world.get_actors(auto_agent_list)
    for v in all_auto_actors:
    ...
    return auto_agent_list, all_auto_actors
