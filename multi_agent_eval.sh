...
export EVAL_CONFIG=${WORK_DIR}/eval_config/1to1/eval_mid.json
export SENSOR_AGNET=${WORK_DIR}/SRL_agent
export AGENT_CONFIG=${WORK_DIR}/checkpoints/tfpp_wp
export DIRECT=0
export RESUME=0
export CHECKPOINT_ENDPOINT=${WORK_DIR}/results/1to1/mid/interaction.json
export SAVE_PATH=${WORK_DIR}/results/1to1/mid
