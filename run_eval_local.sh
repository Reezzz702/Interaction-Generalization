...
export AGENT_CONFIG=${WORK_DIR}/checkpoints/R_wp
export DIRECT=0
export RESUME=1
export REND=0
export CHECKPOINT_ENDPOINT=${WORK_DIR}/results/easy/R/interaction.json
export SAVE_PATH=${WORK_DIR}/results/easy/R
